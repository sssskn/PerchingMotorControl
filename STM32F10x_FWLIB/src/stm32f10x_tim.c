...
void TIM_CCxCmd(TIM_TypeDef* TIMx, uint16_t TIM_Channel, uint16_t TIM_CCx)
{
  ...
  TIMx->CCER |=  (uint16_t)(TIM_CCx << TIM_Channel);	//TIMx->CCER |=  (uint16_t)((TIM_CCx*CCER_CCE_Set) << TIM_Channel);//binÐÞ¸Ä20230815
}
...
void TIM_CCxNCmd(TIM_TypeDef* TIMx, uint16_t TIM_Channel, uint16_t TIM_CCxN)
{
  ...
  TIMx->CCER |=  (uint16_t)(TIM_CCxN << TIM_Channel);//	TIMx->CCER |=  (uint16_t)((TIM_CCxN*CCER_CCNE_Set)<< TIM_Channel);//binÐÞ¸Ä20230815
}
